...
final class PinController extends AbstractController
{
    ...
    public function setupPin(
        ...
        return $this->json(
            $this->authTokenService->createAuthenticatedToken($user, $session, ResponseMessage::REGISTER_SUCCESS)->toArray()
        );
    }
    ...
    public function verifyPin(
        ...
        return $this->json(
            $this->authTokenService->createAuthenticatedToken($user, $session, ResponseMessage::AUTH_COMPLETE)->toArray()
        );
    }
